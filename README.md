...
### お知らせ
現時点で運用にめちゃくちゃ支障のあるバグが残ったままリリースしちゃいました(7/6頃~)
数日以内に対応するので,現時点のバージョンを利用しないでください。
___
...
ページ右側の"Release"をクリックして、一番新しそうな'群大Zoom_forWin_****.zip'をダウンロード

あとは好きな場所で展開してあげてください


#### Macの方
Macの方は'Source Code'の方をダウンロードして、適当にどっかに展開してどうぞ
...
# 注意
ステータス表示はところどころガバガバなのであまり当てになりません。
